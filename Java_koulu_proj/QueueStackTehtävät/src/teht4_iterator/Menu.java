        ...
        private static void printMenu() {
                ...
                do {
                        ...
                        case '1':
                            ...
                            break;
                        case '2':
                            ListItem item = s.pop(); // item saa "Stack's pop" return item = "arvo"
                            if (item == null) // kun returnista tullut item = null;
                                System.out.println("Pino on tyhjä");
                            else
                                System.out.println("Poistettu alkio: "+item.getData()); // saa ListItem's viime arvo
                            break;
                        case '3':
                            s.printItems();
                            break;
